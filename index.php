...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top">
      <div class="container">
        <a class="navbar-brand" href="#">Cookiez</a>
        <button
    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="img/banner.jpg.jpg" class="img-fluid" width="300" />
          <div>
            <h1 class="fw-bold display-4">
              Health Cookiez and Fun for Gen-Z
            </h1>
...
<!-- article end -->
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img/g1 (1).jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="img/g1 (2).jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="img/g1 (3).jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="img/g1 (4).jpg" class="d-block w-100" alt="..." />
            </div>
          </div>
          <button
    ...
    <section id="aboutme" class="text-center p-5 bg-danger-subtle">
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          <div class="p-3">
            <img
              src="img/foto erlina.jpg"
              class="rounded-circle border shadow"
              width="300"
            />
          </div>
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.14869</h3>
            <h1 class="fw-bold">Erlina Putri Lestari</h1>
    ...
    <footer id="footer" class="text-center p-5">
      <div>
        ...
        ></a>
        <a href="https://wa.me/+6285426734433"
          ><i class="bi bi-whatsapp h2 p-2"></i
        ></a>
      </div>
      <div>Erlina Putri Lestari &copy; 2023</div>
    </footer>
    <!-- footer end -->
